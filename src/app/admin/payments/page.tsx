...
const filters = ["ALL", "CREATED", "PENDING", "SUCCESS", "FAILED", "CANCELLED"] as const;
    ...
    <div>
      ...
      <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
        <input
          ...
          placeholder="Search order / ID / txn…"
          value={search}
      ...
      <div className="card mt-5 overflow-x-auto">
        {loading ? (
          ...
          <p className="p-12 text-center text-muted">No payments yet.</p>
        ) : (
